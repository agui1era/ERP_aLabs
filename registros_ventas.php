...
echo "<BR>";
echo "<STRONG>COMISION TOTAL y REEMBOLSO:  <font color=\"red\">".number_format($row[0], 0, ",", ".")."</font><br></STRONG>"; 
...
$query = "select * from alabscl_ventas.registro_ventas_colaborador  ORDER BY FECHA DESC LIMIT 100;";     // Esta linea hace la consulta 
